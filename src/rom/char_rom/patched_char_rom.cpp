...
// 2018-07-21 elmerucr
//
// Part of E64 - Patched Character ROM 2kb
//
// This second charset is extracted from the original roms
// Some characters have been altered/patched for std ascii

#include <cstdint>

uint8_t patched_char_rom[2048] =
{
    0x3c, 0x66, 0x6e, 0x6e, 0x60, 0x62, 0x3c, 0x00,	// 0x100
    ...
    0x00, 0x00, 0x7c, 0x66, 0x66, 0x7c, 0x60, 0x60,	// 0x110
    ...
    0x3c, 0x66, 0x6e, 0x76, 0x66, 0x66, 0x3c, 0x00,	// 0x130
    ...
    0x00, 0x00, 0x00, 0xff, 0xff, 0x00, 0x00, 0x00,	// 0x140
    ...
    0x7c, 0x66, 0x66, 0x7c, 0x60, 0x60, 0x60, 0x00,	// 0x150
...
//    0xc0, 0xc0, 0x30, 0x30, 0xc0, 0xc0, 0x30, 0x30,
    0x00, 0x60, 0x30, 0x18, 0x0c, 0x06, 0x03, 0x00,	// 0x15c - patch for the backslash
    0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18,
//    0x33, 0x33, 0xcc, 0xcc, 0x33, 0x33, 0xcc, 0xcc,
    0x18, 0x3c, 0x66, 0x00, 0x00, 0x00, 0x00, 0x00,	// 0x15e - patch for ^
//    0x33, 0x99, 0xcc, 0x66, 0x33, 0x99, 0xcc, 0x66,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7e, 0x00,	// 0x15f - patch for _
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,	// 0x160
    0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0, 0xf0,
    0x00, 0x00, 0x00, 0x00, 0xff, 0xff, 0xff, 0xff,
//    0xff, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x60, 0x30, 0x18, 0x00, 0x00, 0x00, 0x00, 0x00,	// 0x163 - patch for `
//    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xff,
    0x1c, 0x30, 0x30, 0xe0, 0x30, 0x30, 0x1c, 0x00,	// 0x164 - patch for {
//    0xc0, 0xc0, 0xc0, 0xc0, 0xc0, 0xc0, 0xc0, 0xc0,
    0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x18, 0x00,	// 0x165 - patch for |
//    0xcc, 0xcc, 0x33, 0x33, 0xcc, 0xcc, 0x33, 0x33,
    0x38, 0x0c, 0x0c, 0x07, 0x0c, 0x0c, 0x38, 0x00,	// 0x166 - patch for }
//    0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03, 0x03,
    0x00, 0x00, 0x70, 0xdb, 0x0e, 0x00, 0x00, 0x00,	// 0x167 - patch for ~
    ...
    0x00, 0x00, 0x00, 0x1f, 0x1f, 0x18, 0x18, 0x18,	// 0x170
    ...
    0xc3, 0x99, 0x91, 0x91, 0x9f, 0x99, 0xc3, 0xff,	// 0x180
    ...
    0xff, 0xff, 0x83, 0x99, 0x99, 0x83, 0x9f, 0x9f,	// 0x190
    ...
    0xc3, 0x99, 0x91, 0x89, 0x99, 0x99, 0xc3, 0xff,	// 0x1b0
    ...
    0xff, 0xff, 0xff, 0x00, 0x00, 0xff, 0xff, 0xff,	// 0x1c0
    ...
    0x83, 0x99, 0x99, 0x83, 0x9f, 0x9f, 0x9f, 0xff,	// 0x1d0
...
//    0x3f, 0x3f, 0xcf, 0xcf, 0x3f, 0x3f, 0xcf, 0xcf,
    0xff, 0x9f, 0xcf, 0xe7, 0xf3, 0xf9, 0xfc, 0xff,	// 0x1dc - patch for inversed backslash
    0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7,
//    0xcc, 0xcc, 0x33, 0x33, 0xcc, 0xcc, 0x33, 0x33,
    0xe7, 0xc3, 0x99, 0xff, 0xff, 0xff, 0xff, 0xff,	// 0x1de - patch for inversed ^
//    0xcc, 0x66, 0x33, 0x99, 0xcc, 0x66, 0x33, 0x99,
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x81, 0xff,	// 0x1df - patch for inversed _
    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,	// 0x1e0
    0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f, 0x0f,
    0xff, 0xff, 0xff, 0xff, 0x00, 0x00, 0x00, 0x00,
//    0x00, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff,
    0x9f, 0xcf, 0xe7, 0xff, 0xff, 0xff, 0xff, 0xff,	// 0x1e3 - patch for inversed `
//    0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0x00,
    0xe3, 0xcf, 0xcf, 0x1f, 0xcf, 0xcf, 0xe3, 0xff,	// 0x1e4 - patch for inversed {
//    0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f, 0x3f,
    0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xe7, 0xff,	// 0x1e5 - patch for inversed |
//    0x33, 0x33, 0xcc, 0xcc, 0x33, 0x33, 0xcc, 0xcc,
    0xc7, 0xf3, 0xf3, 0xf8, 0xf3, 0xf3, 0xc7, 0xff,	// 0x1e6 - patch for inversed }
//    0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc, 0xfc,
    0xff, 0xff, 0x8f, 0x24, 0xf1, 0xff, 0xff, 0xff,	// 0x1e7 - patch for inversed ~
    ...
    0xff, 0xff, 0xff, 0xe0, 0xe0, 0xe7, 0xe7, 0xe7,	// 0x1f0
